...
module Scopes =
    ...
    let jominiOneToOneScopesNames = List.map fst jominiOneToOneScopes

    let jominiChangeScope: ChangeScope =
        createJominiChangeScope jominiOneToOneScopes (complexVarPrefixFun "variable:from:" "variable:")
