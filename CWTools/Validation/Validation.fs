...
type ErrorCodes =
    ...
    static member MissingLocalisation =
        fun key language ->
            let lang =
                if language = Lang.STL STLLang.Default then
                    "Default (localisation_synced)"
                else
                    language.ToString()

            { ID = "CW100"
              Severity = Severity.Warning
              Message = sprintf "Localisation key %s is not defined for %s" key lang }
    ...
    static member UndefinedTrigger =
        fun trigger ->
            { ID = "CW102"
              Severity = Severity.Error
              Message = sprintf "unknown trigger %s used." trigger }

    static member UndefinedEffect =
        fun effect ->
            { ID = "CW103"
              Severity = Severity.Error
              Message = sprintf "unknown effect %s used." effect }

    static member IncorrectTriggerScope =
        fun (trigger: string) (actual: string) (expected: string) ->
            { ID = "CW104"
              Severity = Severity.Error
              Message = sprintf "%s trigger used in incorrect scope. In %s but expected %s" trigger actual expected }

    static member IncorrectEffectScope =
        fun (trigger: string) (actual: string) (expected: string) ->
            { ID = "CW105"
              Severity = Severity.Error
              Message = sprintf "%s effect used in incorrect scope. In %s but expected %s" trigger actual expected }

    static member IncorrectScopeScope =
        fun (scope: string) (actual: string) (expected: string) ->
            { ID = "CW106"
              Severity = Severity.Error
              Message = sprintf "%s scope command used in incorrect scope. In %s but expected %s" scope actual expected }

    static member EventEveryTick =
        { ID = "CW107"
          Severity = Severity.Information
          Message =
            "This event might affect performance as it runs on every tick, consider adding 'is_triggered_only', 'fire_only_once' or 'mean_time_to_happen'" }

    static member ResearchLeaderArea =
        { ID = "CW108"
          Severity = Severity.Error
          Message = "This research_leader is missing required \"area\"" }

    static member ResearchLeaderTech =
        fun actual expected ->
            { ID = "CW109"
              Severity = Severity.Information
              Message = sprintf "This research_leader uses area %s but the technology uses area %s" actual expected }

    static member TechCatMissing =
        { ID = "CW110"
          Severity = Severity.Error
    ...
    static member PossiblePretrigger =
        fun (trigger: string) ->
            { ID = "CW120"
              Severity = Severity.Information
              Message = sprintf "Trigger %s can be made a pretrigger (see code action to fix)" trigger }

    static member EmptyIf =
        { ID = "CW121"
          Severity = Severity.Warning
          Message = "This 'if' trigger contains no effects" }
    ...
    static member LocalisationKeyInInline =
        fun key ->
            { ID = "CW122"
              ...
              Message =
                sprintf
                    "Localisation key %s should not be quoted when used inline, this can cause unexpected behaviour"
                    key }

    static member UnsavedEventTarget =
        fun (event: string) (targets: string) ->
            { ID = "CW220"
              Severity = Severity.Error
              Message =
                sprintf
                    "%s or an event it calls require the event target(s) %s but they are not set by this event or by all possible events leading here"
                    event
                    targets }

    static member MaybeUnsavedEventTarget =
        fun (event: string) (targets: string) ->
            { ID = "CW221"
              Severity = Severity.Warning
              Message =
                sprintf
                    "%s or an event it calls require the event target(s) %s but they may not always be set by this event or by all possible events leading here"
                    event
                    targets }

    static member UndefinedEvent =
        fun (event: string) ->
            { ID = "CW222"
              Severity = Severity.Warning
              Message = sprintf "The event id %s is not defined" event }

    static member IncorrectNotUsage =
        { ID = "CW223"
          Severity = Severity.Information
    ...
    static member UnknownSectionTemplate =
        fun (name: string) ->
            { ID = "CW227"
              Severity = Severity.Error
              Message = sprintf "Section template %s can not be found" name }

    static member MissingSectionSlot =
        fun (section: string) (slot: string) ->
            { ID = "CW228"
              Severity = Severity.Error
              Message = sprintf "Section template %s does not have a slot %s" section slot }

    static member UnknownComponentTemplate =
        fun (name: string) ->
            { ID = "CW229"
              Severity = Severity.Error
              Message = sprintf "Component template %s can not be found" name }

    static member MismatchedComponentAndSlot =
        fun (slot: string) (slotsize: string) (template: string) (templatesize: string) ->
            { ID = "CW230"
              Severity = Severity.Warning
              Message =
                sprintf
                    "Component and slot do not match, slot %s has size %s and component %s has size %s"
                    slot
                    slotsize
                    template
                    templatesize }

    static member UnusedTech =
        fun (tech: string) ->
            { ID = "CW231"
              Severity = Severity.Warning
    ...
    static member UndefinedSectionEntity =
        fun (entity: string) (culture: string) ->
            { ID = "CW233"
              Severity = Severity.Error
              Message = sprintf "Entity %s is not defined for culture %s" entity culture }

    static member UndefinedSectionEntityFallback =
        fun (entity: string) (fallback: string) (culture: string) ->
            { ID = "CW233"
              Severity = Severity.Error
              Message = sprintf "Entity %s is not defined for culture %s (nor is fallback %s)" entity culture fallback }

    static member UndefinedEntity =
        fun (entity: string) ->
            { ID = "CW233"
              Severity = Severity.Error
              Message = sprintf "Entity %s is not defined" entity }

    static member ReplaceMeLoc =
        fun (key: string) (language: Lang) ->
            let lang =
                if language = Lang.STL STLLang.Default then
                    "Default (localisation_synced)"
                else
            ...
            { ID = "CW234"
              Severity = Severity.Information
              Message = sprintf "Localisation key %s is a placeholder for %s" key lang }

    static member ZeroModifier =
        fun (modif: string) ->
            { ID = "CW235"
              Severity = Severity.Warning
              Message = sprintf "Modifier %s has value 0. Modifiers are additive so likely doesn't do anything" modif }

    static member DeprecatedElse =
        { ID = "CW236"
          Severity = Severity.Warning
          Message = "Nested if/else in effects was deprecated with 2.1 and will be removed in a future release" }

    static member AmbiguousIfElse =
        { ID = "CW237"
          Severity = Severity.Information
          Message = "2.1 changed nested if = { if else } behaviour in effects. Check this still works as expected" }

    static member IfElseOrder =
        { ID = "CW238"
          Severity = Severity.Error
    ...
    static member ConfigRulesUnexpectedProperty =
        fun message severity ->
            { ID = "CW241"
              Severity = severity
              Message = message }

    static member ConfigRulesWrongNumber =
        fun message severity ->
            { ID = "CW242"
              Severity = severity
              Message = message }

    static member ConfigRulesTargetWrongScope =
        fun scope expected target ->
            { ID = "CW243"
              Severity = Severity.Error
              Message = sprintf "Target \"%s\" has incorrect scope. Is %s but expect %s" target scope expected }

    static member ConfigRulesInvalidTarget =
        fun expected target ->
            { ID = "CW244"
              Severity = Severity.Error
              Message = sprintf "%s is not a target. Expected a target in scope(s) %s" target expected }

    static member ConfigRulesErrorInTarget =
        fun command scope expected ->
            { ID = "CW245"
              Severity = Severity.Error
              Message = sprintf "Error in target. Link %s was used in scope %s but expected %s" command scope expected }
    ...
    static member ConfigRulesRuleWrongScope =
        fun scope (expected: string) actual ->
            { ID = "CW247"
              Severity = Severity.Error
              Message =
                sprintf "Trigger/Effect/Modifier %s used in wrong scope. In %s but expect %s" actual scope expected }

    static member ConfigRulesInvalidScopeCommand =
        fun command ->
            { ID = "CW248"
              Severity = Severity.Error
              Message = sprintf "Invalid scope command %s" command }
    ...
    static member UnnecessaryBoolean =
        fun logicOperator ->
            { ID = "CW251"
              Severity = Severity.Warning
    ...
    static member DeprecatedSetName =
        { ID = "CW253"
          Severity = Severity.Information
          Message = "Consider using \"set_name\" instead for consistency" }

    static member WrongEncoding =
        { ID = "CW254"
          Severity = Severity.Error
          Message = "Localisation files must be UTF-8 BOM, this file is not" }
    ...
    static member MissingLocFileLangHeader =
        { ID = "CW256"
          Severity = Severity.Error
          Message = "Localisation file should start with \"l_language:\" on the first line (or a comment)" }

    static member LocFileLangMismatch =
        fun (name: STLLang) (header: STLLang) ->
            { ID = "CW257"
              Severity = Severity.Error
              Message =
                sprintf "Localisation file's name has language %A doesn't match the header language %A" name header }

    static member LocFileLangWrongPlace =
        { ID = "CW258"
          Severity = Severity.Information
          Message = "Localisation file name should end with \"l_language.yml\"" }

    static member RecursiveLocRef =
        { ID = "CW259"
          Severity = Severity.Error
          Message = "This localisation string refers to itself" }

    static member LocCommandWrongScope =
        fun command expected actual ->
            { ID = "CW260"
              Severity = Severity.Error
              Message = sprintf "Loc command %s used in wrong scope. In %s but expected %s" command actual expected }

    static member DuplicateTypeDef =
        fun typename actualtype ->
            { ID = "CW261"
              Severity = Severity.Error
              Message = sprintf "Key %s of type %s is defined multiple times" actualtype typename }

    static member ConfigRulesUnexpectedPropertyNode =
        fun message severity ->
            { ID = "CW262"
              Severity = severity
              Message = message }

    static member ConfigRulesUnexpectedPropertyLeaf =
        fun message severity ->
            { ID = "CW263"
              Severity = severity
              Message = message }

    static member ConfigRulesUnexpectedPropertyLeafValue =
        fun message severity ->
            { ID = "CW264"
              Severity = severity
              Message = message }

    static member ConfigRulesUnexpectedPropertyValueClause =
        fun message severity ->
            { ID = "CW265"
              Severity = severity
              Message = message }

    static member LocCommandNotInDataType =
        fun key command datatype confident ->
            let sev = if confident then Severity.Error else Severity.Warning

            let message =
                sprintf "Localisation key %s uses command %s which does not exist in data type %s." key command datatype

            let message =
                if confident then
                    message
                else
                    sprintf "%s (guessed data type)" message

            { ID = "CW266"
              Severity = sev
              Message = message }

    static member ConfigRulesUnexpectedAliasKeyValue =
        fun key expected severity ->
            { ID = "CW267"
              Severity = severity
              Message = sprintf "Expected a %s value, got %s" key expected }

    static member LocMissingQuote =
        fun key ->
            { ID = "CW268"
              Severity = Severity.Warning
              Message = sprintf "Localisation key %s doesn't start and end with double quotes" key }

    static member OptimisationMergeList =
        fun inner target ->
            { ID = "CW269"
              Severity = Severity.Hint
              Message = sprintf "Optimise by merging this with %s by using %s" inner target }

    static member ConfigRulesVariableTooSmall =
        { ID = "CW270"
          Severity = Severity.Warning
          Message = "Value too small, only 3 decimal places are supported in this context" }

    static member ConfigRulesVariableIntOnly =
        { ID = "CW271"
          Severity = Severity.Warning
          Message = "Expected an integer" }

    static member FromRulesCustomError =
        fun error severity ->
            { ID = "CW272"
              Severity = severity
              Message = error }

    static member UndefinedModifierTypeForModifier =
        fun modifierType ->
            { ID = "CW273"
              Severity = Severity.Warning
              Message = sprintf "Modifier type %s is not defined but is used" modifierType }

    static member InlineScriptResultsInError =
        fun severity ->
            { ID = "CW274"
              Severity = severity
...
type EntitySet<'T when 'T :> ComputedData>(entities: struct (Entity * Lazy<'T>) seq) =
    ...
    member _.AddOrGetCached id generator =
        ...
        |> List.collect (fun struct (e, d) ->
            ...
            | Some v -> v
            | None ->
                let v = generator e in
                data.Cache <- Map.add id v data.Cache
                v)
...
module ValidationCore =
    ...
    let inline inv (code: ErrorCode) l = invData code l None
    ...
    let merger original news =
        ...
        | Invalid(_, []), Invalid(_, es)
        | OK, Invalid(_, es) -> Some(mergeValidationErrors "CW240" es)
    ...
    let inline lazyErrorMerge rs f ([<InlineIfLambda>] defValue) (errors: ValidationResult) merge =
        ...
        let struct (foundOK, any, res) =
            rs
            |> Seq.fold
                (fun struct (foundOK, any, es) r ->
                    if foundOK then
                        struct (foundOK, any, es)
                    else
                        (let x = f r es in
                         ...
                         if x.Equals es then
                             ...
                             struct (foundOK, true, x)))
                struct (false, false, errors)
